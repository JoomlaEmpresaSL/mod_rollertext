...
<div id="panel" style="float: <?php echo $posicom_painel; ?>; width: 1%; height: <?php echo $alto; ?>px; filter:alpha(opacity=<?php echo $trans_painel*100 ?>); color: #FFF; background-color: <?php echo $corpainel; ?>; -khtml-opacity: <?php echo $trans_painel ?>; opacity: <?php echo $trans_painel ?>; overflow: hidden;">
